...
export const PaymentMethod: React.FC<IProps> = (props) => {
        ...
        <>
            <Box style={{ display: 'flex', justifyContent: 'center'}}>
                <div  style={{width: '60%'}}>
                    ...
                    <RadioGroup onChange={setSelected} value={selected} style={{paddingTop: '1rem'}}>
                    ...
                    <div style={{padding: '2rem 0'}}>
                        <span style={{fontSize: '1.5rem'}}>Cena celkem: {props.totalAmount} Kč</span>
                    </div>
                </div>
            </Box>
        </>
