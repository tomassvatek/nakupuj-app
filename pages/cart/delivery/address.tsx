import {Box, Input, Image, HStack, useRadioGroup, useRadio, Select, FormControl, Button} from "@chakra-ui/react";
            ...
            <Box style={{display: 'flex', justifyContent: 'center'}}>
                <div style={{width: '60%', paddingTop: '3rem'}}>
                    ...
                    <FormControl id="address" isRequired>
                        <Input placeholder="Doručovací adresa" size="md" style={{margin: '1rem 0'}}/>
                    </FormControl>
                    <Image
                        src="https://media.wired.com/photos/59269cd37034dc5f91bec0f1/191:100/w_1280,c_limit/GoogleMapTA.jpg"
                        alt="Segun Adebayo" style={{marginBottom: '1rem', padding: '0 4rem'}}/>
